...
const AddDevice = (): JSX.Element => {
  ...
  return (
    <Box>
      ...
      <Box sx={{ backgroundColor: 'common.white', width: '90%', px: 3, py: 4, borderRadius: '16px' }}>
        <FormProvider {...methods}>
          <Box component="form" noValidate onSubmit={methods.handleSubmit(handleSubmit)}>
            ...
            <Grid item xs={12} mb={3}>
              <TextField name="serviceUsed" label="Dịch vụ sử dụng:" placeholder="Nhập dịch vụ sử dụng" />
            </Grid>
