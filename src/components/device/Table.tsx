        ...
        <Box flexGrow={1} display="flex">
          <Box width="20%" mr={8}>
            ...
            <AutoComplete
              ...
              options={[
                { id: operationStatus.ALL, label: OperationStatusOption[operationStatus.ALL].label },
                { id: operationStatus.ON, label: OperationStatusOption[operationStatus.ON].label },
                { id: operationStatus.OFF, label: OperationStatusOption[operationStatus.OFF].label },
              ]}
              getItemLabel={(item) => item.label}
              getItemValue={(item) => item.id}
              defaultValue={{ id: operationStatus.ALL, label: OperationStatusOption[operationStatus.ALL].label }}
            />
          </Box>
          <Box width="20%">
            ...
            <AutoComplete
              ...
              options={[
                { id: connectionStatus.ALL, label: ConnectionStatusOption[connectionStatus.ALL].label },
                { id: connectionStatus.ON, label: ConnectionStatusOption[connectionStatus.ON].label },
                { id: connectionStatus.OFF, label: ConnectionStatusOption[connectionStatus.OFF].label },
              ]}
              getItemLabel={(item) => item.label}
              getItemValue={(item) => item.id}
              defaultValue={{ id: connectionStatus.ALL, label: ConnectionStatusOption[connectionStatus.ALL].label }}
            />
          </Box>
        </Box>
        <Box>
